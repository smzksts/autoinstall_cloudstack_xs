* What is this?
  ...
  This is an easy installation script for CloudStack 4.4 on XenServer.
  This script automates installation on a fresh CentOS 6.4 node by using minimal netinstall.
